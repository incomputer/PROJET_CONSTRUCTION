...
try{
    ...
    $statement = $db->prepare("INSERT INTO publier_location(publier_ville_location,publier_commune_location,publier_quartier_location,publier_nbrepiece_location,publier_montant_location,publier_image_location,id_immobilier) values(?,?,?,?,?,?,?)");
