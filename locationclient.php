                ...
                <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                    <div id="ticketModal6" class="w3-modal">
                        ...
                        class="w3-button w3-teal w3-xlarge w3-display-topright">×</span>
                            <h2 class="w3-wide"><i class="fa fa-user w3-margin-right"></i>Formulaire adressé aux personnes qui voudraient louer cette maison</h2>
                        </header>
...
$db = Database::connect();
$statement = $db->prepare("INSERT INTO `achat_location` (`nom_prenoms_achat`, `contact_achat`, `mail_achat`, `id_immobilier`) VALUES (?,?,?,?)");
